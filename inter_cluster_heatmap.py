...
heatmap_data = (heatmap_data / G.number_of_nodes()) * 100
# female_heatmap_data = (female_heatmap_data / female_heatmap_data.sum()) * 100
...
# sns.heatmap(heatmap_df, annot=True, fmt=".0f", cmap="Greens", cbar=True)
sns.heatmap(heatmap_df, annot=True, fmt=".1f", cmap="Greens",cbar_kws={'format': '%.0f%%'})
plt.title("Human Computer Interaction Heatmap of Inter-Gender Connections by Degree Bins", fontsize=16)
